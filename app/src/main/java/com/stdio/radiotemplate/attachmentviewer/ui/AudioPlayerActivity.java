...
public class AudioPlayerActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    private com.stdio.radiotemplate.attachmentviewer.MusicService MusicService;
    ...
    protected void onResume() {
        super.onResume();
        //bind to service
        MusicServiceIntent = new Intent(this, com.stdio.radiotemplate.attachmentviewer.MusicService.class);
    ...
    private final class MusicServiceServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder baBinder) {
            ...
            MusicService = ((com.stdio.radiotemplate.attachmentviewer.MusicService.MusicServiceBinder) baBinder).getService();
